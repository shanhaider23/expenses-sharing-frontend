...
const InfoCard = (props) => {
  ...
  const allEmpty = () => (
    <div className="empty">
      ...
      <p>
        <span className="round">1</span>Name your thing
      </p>
      <p>
        <span className="round">2</span>Make your group
      </p>
      <p>
        <span className="round">3</span>Add your expenses
      </p>
    </div>
  );
  ...
  const first = () => (
    <div>
      ...
      <div className="flexDisplay blocks">
        <i className="material-icons calendar">event</i>
  ...
  if (IsFirstCardUp && IsSecondCardUp && IsThirdCardUp && !IsFinalCardUp) {
    ...
    return <Card className="infoCard">{allEmpty()}</Card>;
  }
};
